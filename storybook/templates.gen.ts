...
`,
  ...
  <screen>
    <styles>
      <style id="Body" backgroundColor="white" flex="1" />
      <style id="img" width="200" height="200" />
    </styles>
    <body style="Body">
      <image
        source="https://upload.wikimedia.org/wikipedia/en/a/a4/Guns-N-Roses-1987.jpg"
        style="img"
      />
    </body>
  </screen>
...
`,
  ...
  <screen>
    <styles>
      ...
      <style
        id="SelectCustom__ImageWrapper"
        marginBottom="8"
        width="32"
        height="32"
      />
      <style
        id="SelectCustom__Image"
        width="32"
        height="32"
        position="absolute"
        top="0"
    ...
    <body style="Body">
      <option style="SelectCustom__Option" value="free_parking" selected="true">
        <view style="SelectCustom__ImageWrapper">
          <image
            style="SelectCustom__Image SelectCustom__Image--Unselected"
            source="/ui_elements/forms/unselected.png"
          />
          <image
            style="SelectCustom__Image SelectCustom__Image--Selected"
            source="/ui_elements/forms/selected.png"
          />
        </view>
...
`,
  ...
  <screen>
    <styles>
      ...
      <style id="Basic" fontSize="24" fontWeight="500" margin="24" />
      <style id="Bold" fontSize="16" fontWeight="bold" margin="24" />
      <style
        id="Color"
  ...
  <screen>
    <styles>
      ...
      <style
        ...
        margin="24"
      />
      <style id="ScrollContainer--Vertical" flexDirection="column" />
      <style id="ScrollContainer--Horizontal" flexDirection="row" />
      <style
        id="ScrollChild"
        backgroundColor="#63CB76"
        borderRadius="16"
