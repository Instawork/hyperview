...
describe('MaxValue', () => {
  describe('check', () => {
    ...
    it('returns invalid if max attribute is non-number', async () => {
    ...
    it('returns valid if value is 0', async () => {
      const e = v('<v:max-value max="2" />');
      expect(MaxValue.check('0', e)).toEqual({ valid: true });
    });
    it('returns valid if value is less than max', async () => {
      const e = v('<v:max-value max="2" />');
      expect(MaxValue.check('1', e)).toEqual({ valid: true });
    });
    it('returns valid if value is equal to max', async () => {
      const e = v('<v:max-value max="2" />');
      expect(MaxValue.check('2', e)).toEqual({ valid: true });
    });
    it('returns valid if float value is less than max', async () => {
      const e = v('<v:max-value max="2" />');
      expect(MaxValue.check('1.9', e)).toEqual({ valid: true });
    });
    it('returns invalid if value is greater than max', async () => {
      const e = v('<v:max-value max="2" />');
    ...
    it('returns invalid if float value is greater than max', async () => {
      const e = v('<v:max-value max="2" />');
    ...
    it('returns invalid if float value is greater than float max', async () => {
    ...
    it('returns valid if float value is equal to float max', async () => {
      const e = v('<v:max-value max="2.5" />');
      expect(MaxValue.check('2.5', e)).toEqual({ valid: true });
    });
    it('returns valid if float value is less than float max', async () => {
      const e = v('<v:max-value max="2.5" />');
      expect(MaxValue.check('2.499', e)).toEqual({ valid: true });
    });

    it('returns invalid if value is greater than negative max', async () => {
      const e = v('<v:max-value max="-2" />');
    ...
    it('returns valid if float value is equal to negative max', async () => {
      const e = v('<v:max-value max="-2" />');
      expect(MaxValue.check('-2', e)).toEqual({ valid: true });
    });
    it('returns valid if float value is less than negative max', async () => {
      const e = v('<v:max-value max="-2" />');
      expect(MaxValue.check('-2.1', e)).toEqual({ valid: true });
    });

    it('returns invalid if value is greater than negative float max', async () => {
      const e = v('<v:max-value max="-2.5" />');
    ...
    it('returns valid if float value is equal to negative float max', async () => {
      const e = v('<v:max-value max="-2.5" />');
      expect(MaxValue.check('-2.5', e)).toEqual({ valid: true });
    });
    it('returns valid if float value is less than negative float max', async () => {
      const e = v('<v:max-value max="-2.5" />');
